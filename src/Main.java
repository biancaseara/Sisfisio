...
public class Main {
    public static void main(String[] args) {
        ...
        Admin admin = new Admin("Admin", "12345678901", "12345678", data, endereco, "12345678901", "admin");
        ...
        Paciente paciente = new Paciente("Paciente 1", "11111111111", "11111111", data, endereco, "10100001111", "senha", TipoSanguineo.O_POSITIVO, alergias, comorbidades, medicamentos,Status.AGENDADO);
        Paciente paciente2 = new Paciente("Paciente 2", "22222222222", "22222222", data, endereco, "10100002222", "senha", TipoSanguineo.O_POSITIVO, alergias, comorbidades, medicamentos,Status.EM_TRATAMENTO);
        Consulta consulta = new Consulta(paciente.getStatus_paciente(), 0, data,procedimentos);
        Medico medica = new Medico("Leonardo","09411790526", "1632029526", data, endereco, "75-982615462", "senha", Especialidade.FISIOTERAPIA_AQUATICA,"1254" );
